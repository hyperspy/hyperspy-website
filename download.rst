...
`HyperSpy-1.0.1 for Windows 32-bits
<https://github.com/hyperspy/hyperspy/releases/download/v1.0.1/HyperSpy-v1.0.1-Bundle-Windows-32bit.exe>`_

`HyperSpy-1.0.1 for Windows 64-bits
<https://github.com/hyperspy/hyperspy/releases/download/v1.0.1/HyperSpy-v1.0.1-Bundle-Windows-64bit.exe>`_
